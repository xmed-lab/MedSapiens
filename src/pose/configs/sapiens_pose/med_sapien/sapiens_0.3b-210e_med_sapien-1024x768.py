...
dataset_coco = dict(
    ...
    data_mode='topdown',
    ann_file='med_sapien_coco_train_annotations.json',
...
dataset_coco_val = dict(
    ...
    data_root='../../data/med_sapien',
    data_mode='topdown',
    ann_file='med_sapien_coco_val_annotations.json',
    data_prefix=dict(img='Images/'),
)
...
dataset_coco_test = dict(
    ...
    data_root='../../data/med_sapien',
    data_mode='topdown',
    ann_file='med_sapien_coco_test_annotations.json',
    data_prefix=dict(img='Images/'),
)
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(from_file='configs/_base_/datasets/med_sapien.py'),
